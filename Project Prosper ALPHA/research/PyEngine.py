...
pygame.init()
buttons,messages,elements,_mouseDown,liveProjectiles,activeAnimations=[],[],[],False,[],[]
...
class Projectile:
    def __init__(self,width:float,height:float,speed:float,acceleration:float,lifetime:float,shootMouse:bool,sprite,damage,xAcc=0,yAcc=0,x=0,y=0,offset=(0,0),pierce=0,immune=list()) -> None:
        self.x,self.y=x,y
...
if __name__=='__main__':
    ...
    print('Using PyEngine v0.6 APLHA') 
